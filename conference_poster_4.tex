...
\headerbox{Problem: Detecting Boundaries for Specific Objects}{name=objectives,column=0,span=1, row=0}{
...
\headerbox{Segmentation Baseline}{name=content,column=1,span=1, row=0}{
...
\headerbox{Masked Boundary Baseline}{name=texture,column=1,span=1, below=content}{
\begin{minipage}{1\linewidth}
\begin{minipage}[t]{1\linewidth}
\begin{center}
...
\headerbox{Local Class-Specific Boundary Detector}{name=loss,column=1,span=1,below=texture}{
...
\headerbox{Information Fusion}{name=multiscale,column=1,span=1,bottomaligned = algorithm, below=loss}{
...
\headerbox{Numerical Results on VOC2012}{name=weight,column=2,span=1, row=0}{ % This block's bottom aligns with the bottom of the conclusion block
...
\headerbox{Visual Results on VOC2012}{name=drop_content,column=2,span=1, below=weight }{ % This block's bottom aligns with the bottom of the conclusion block
...
\headerbox{Results on Microsoft COCO}{name=drop_adversarial,column=2,span=1, below=drop_content}{ 
...
\headerbox{Class-Agnostic Results}{name=comparison,column=2,span=1, below=drop_adversarial}{
\begin{minipage}{1\linewidth}
\begin{center}
...
\headerbox{Relationship Between Boundary Detection and Semantic Segmentation}{name=imagenet,column=3,span=1, row=0}{ 
...
\headerbox{\small Effect of Dilation/Erosion Radius}{name=paris,column=3,span=1, below=imagenet}{ 
\begin{minipage}{1\linewidth}
\setlength\tabcolsep{1.5pt}
\centering
\tiny
